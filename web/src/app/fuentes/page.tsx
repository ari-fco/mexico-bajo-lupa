...
const SOURCES = [
  {
    ...
    files: [
      ...
      "IDEFM_NM Municipal · fuero común (V5)",
      "IDVFC Víctimas (V2)",
    ],
  ...
  },
  {
    ...
    files: [
      ...
      "Marco Geoestadístico (gaia.inegi.org.mx/wscatgeo) — V2",
      "Censo 2020 · tabulados básicos — V2",
    ],
  ...
  },
  {
    ...
    files: [
      ...
      "Histórico CompraNet 5.0 (2010-2022) — pendiente V4",
    ],
  ...
  },
  {
    ...
    files: [
      ...
      "Cuenta Pública (V3)",
      "PEF · Programa Federalizado por programa/fondo (V3)",
    ],
  ...
  },
  {
    ...
    files: [
      ...
      "Series históricas 2008-2020 — V2",
    ],
